        ...
        <div class="min-w-0 flex-1">
            <form action="#" class="relative">
                <div
                    ...
                    <textarea rows="3" name="comment" id="comment" v-model="modelValue"
                                            ...
                                            <span v-if="!(selected.value === null)">
                                                <span
                                                    ...
                                                    <component :is="selected.icon"
                                                        class="h-5 w-5 flex-shrink-0 text-white" aria-hidden="true" />
                                                </span>
                                    ...
                                    <transition leave-active-class="transition ease-in duration-100"
                                        ...
                                        <ListboxOptions
                                            ...
                                            <ListboxOption as="template" v-for="mood in moods"
                                                :key="mood.value as string" :value="mood" v-slot="{ active }">
                                                <li
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <span class="ml-3 block truncate font-medium">{{ mood.name
                                                            }}</span>
                                                    </div>
                                                </li>
                                            </ListboxOption>
